...
| **Current batch** | Batch 0.4 — blocked (partial), see below |
| **Next action** | Batch 0.5 — database foundation. Batch 0.4's asset-bundling work stays blocked until someone with access to tanzil.net/qul.tarteel.ai (or a decision on an alternate image/coordinate source) can pick it up — see blocker #5 |
